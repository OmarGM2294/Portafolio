...
function choise(obj,e) {
    if (e.keyCode == 13) {
    	if($(obj).val() == "./about_me.txt"){
            ...
            $(".container-fluid").append('<div id="dir" style="padding-left: 20px;"><br><div style="margin-left: -20px;">C:\>  <input type="text" onkeypress="choise(this,event);" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"/></div></div>');
            $("#dir input").focus();
    	}
    		...
    		$(".container-fluid").append('<div id="error" style="padding-left: 20px;"><br>\''+$(obj).val()+'\' is not recognized as an internal or external command, operable program or batch file.<br><br><div style="margin-left: -20px;">C:\>  <input type="text" onkeypress="choise(this,event);" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"/></div></div>');
    		$(obj).css("disable", true);
    		$("#error input").focus();
    	}
    }
